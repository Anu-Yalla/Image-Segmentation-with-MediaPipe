...
st.title("🖼️ Image Segmentation with MediaPipe Computer Vision")
...
# Resive image to be compatible with Mediapipe model
...
if uploaded_file is not None:
    try:
        ...
        # Apply and display blurred background picture
